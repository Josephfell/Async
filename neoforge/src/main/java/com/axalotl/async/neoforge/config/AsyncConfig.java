...
public class AsyncConfig {
    ...
    private static final ModConfigSpec.BooleanValue synchronizeEntityEvents;
    ...
    static {
        ...
        synchronizeEntityEvents = BUILDER.comment("Synchronizes entity tick event bus dispatch to prevent ConcurrentModificationException from mods with non-thread-safe event handlers (e.g. Reliquary, Create). Enable this for modpacks like A10. Reduces parallelism but prevents crashes.")
                .define("synchronizeEntityEvents", com.axalotl.async.common.config.AsyncConfig.synchronizeEntityEvents);
    ...
    public static void loadConfig() {
        ...
        com.axalotl.async.common.config.AsyncConfig.synchronizeEntityEvents = synchronizeEntityEvents.get();
    ...
    public static void saveConfig() {
        ...
        synchronizeEntityEvents.set(com.axalotl.async.common.config.AsyncConfig.synchronizeEntityEvents);
